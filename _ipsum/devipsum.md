...
- "Este requisito não estava no escopo do projeto."
- "Não precisa abrir chamado de erro de teste, arrumo rapidão."
- "Não preciso comentar os códigos, só eu trabalho com esse módulo mesmo."
- "Não sei o que é isso ."
- "Q'Porra é essa?"
- "Vc viu um artigo sobre <tecnologia da moda qualquer >? Vai ser uma revolução."
- "Não é defeito. É assim mesmo, deixa eu te explicar..."
- "Não tinha isso aí no requisito... Ahhhh tá, era pra eu adivinhar com minha onisciencia."
...
- "Já tá quase pronto!"
- "Deu conflito!"
- "Se acabar o café eu vou embora."
- "É cache e na vtex o cache leva 1 dia pra virar."
- "É culpa de quem desenvolveou estas linhas de codigo procedural aqui."
- "Qual o sabor da pizza hoje?"
- "Depois eu documento todos os métodos de uma vez."
- "Esqueci de fazer Backup , mas a culpa não é minha."
- "Deve ser problema de parse."
- "Agora só dar um commit, push é já era."
- "Reinicia a máquina que o site volta a funcionar."
- "É so fazer certo que da certo."
---